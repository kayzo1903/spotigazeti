...
const Header = () => {
  ...
  return (
    <header className="w-full bg-skin2 h-16 sticky top-0 z-50">
      <div className="max-w-screen-xl text-whit mx-auto ">
        <div className="w-full flex p-5 justify-between items-center">
          ...
          <Themeswitch />
          <nav className="hidden md:flex flex-wrap items-center text-base justify-center text-white">
